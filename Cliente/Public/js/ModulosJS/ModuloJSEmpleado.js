...
let opcion, id, codigo,nombre, apellido, direccion, telefono, estado, fila;
...
$(document).ready(async function () {
    ...
    try {
        ...
        const Empleados = await api.excuteGet('empleado');
...
$(document).on("click", ".btnBorrar", async function () {
    ...
    if (confirmacion.isConfirmed) {
        ...
        $('#form').submit(async function (e) {
            ...
            try {
                if (opcion === 'crear') {
                    await api.excutePost('empleado',{nombre, apellido, direccion, telefono, estado });
                } else if (opcion === 'editar') {
                    await api.excutePut(`empleado/${codigo}`, {nombre, apellido, direccion, telefono, estado });
                }
